...
:::{.incremental}
- The first two principal components almost reproduce the map of Europe.
...
:::{.fragment}
This tells us that the eigenvalues $\lambda_i$ of $S$ are the squares of the singular values $\sigma_i^2$ of $X$, scaled by $\frac{1}{m-1}$.
:::
...
## Case Study: Random Data
:::{style="font-size: 0.8em; "}
The directions of the principal components are orthogonal and correspond to the directions of the maximum variance.
